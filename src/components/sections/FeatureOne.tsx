    ...
    <>
      <div className="flex flex-col md:flex-row md:gap-x-28 md:items-center">
        <div className="relative overflow-hidden w-full h-auto md:max-w-[560px]">
          <div
            className="w-full overflow-hidden relative h-[200px] md:h-[700px] rounded-2xl"
            style={{
              background: "#553a1b",
            }}
          >
        ...
        <div className="w-full mt-6 md:mt-0">
          ...
          <div className="flex flex-col gap-y-8">
            <div className="flex flex-col">
              <div
                className="flex flex-col md:pr-12 w-full gap-y-6"
            ...
            <div className="md:flex  md:flex-row gap-4 flex-wrap">
              <Button
                color={"default"}
                variant={"flat"}
                className={`text-tow-secondary reset-min-w bg-tow-primary font-medium py-6 px-9 rounded-[30px] text-base`}
                style={
                  {
